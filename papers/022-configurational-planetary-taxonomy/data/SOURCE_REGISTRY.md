...
This file is the **current canonical key → source map**. Historical revisions are not required to resolve a source key.

## Core classification / physical / orbital sources

- `IAU_2006_B5_B6` — https://iau.org/Iau/Publications/List-of-Resolutions
- `JPL_PLANET_PHYS` — https://ssd.jpl.nasa.gov/planets/phys_par.html
- `JPL_APPROX_PLANET_ELEMENTS` — https://ssd.jpl.nasa.gov/planets/approx_pos.html
- `JPL_SAT_PHYS` — https://ssd.jpl.nasa.gov/sats/phys_par/
- `JPL_SAT_MEAN_ELEMENTS` — https://ssd.jpl.nasa.gov/sats/elem/
- `JPL_ASTRO_PARAMS` — https://ssd.jpl.nasa.gov/astro_par.html
- `JPL_SBDB_API` — https://ssd-api.jpl.nasa.gov/doc/sbdb.html
- `JPL_SBDB_QUERY` — https://ssd-api.jpl.nasa.gov/doc/sbdb_query.html
- `JPL_SB_ELEMENT_TABLES` — https://ssd.jpl.nasa.gov/sb/elem_tables.html
- `JPL_SB_ORBITS` — https://ssd.jpl.nasa.gov/sb/orbits.html

## Evidence batch 01 · planets + Ceres/Pluto
...
- `PROTOCOL_DIRECT_SUN_DEFAULT` — ARIS4C022 `process/EVIDENCE_STATE_PROTOCOL.md`; direct-Sun non-satellite tidal-heating N/A rule.

## Evidence batch 02 · high-information moons
...
## Evidence batch 03 · mid-sized moons + remaining dwarf planets
...
- `PALLAS_HYDRATION_1983` — https://doi.org/10.1016/0019-1035(83)90161-6
- `PALLAS_THERMAL_2012` — https://doi.org/10.1016/j.icarus.2011.11.019
- `HYGIEA_HYDRATION_2026` — https://academic.oup.com/mnras/article/546/2/staf2171/8440177
- `HYGIEA_SHAPE_2019` — https://doi.org/10.1038/s41550-019-0915-8
- `INTERAMNIA_SPECTRUM_2026` — https://dergipark.anas.az/index.php/ajaz/article/view/4265
- `INTERAMNIA_AA_2020` — https://www.aanda.org/articles/aa/abs/2020/01/aa36639-19/aa36639-19.html
- `QUAOAR_ICE_NATURE_2004` — https://doi.org/10.1038/nature03111
- `QUAOAR_APJ_2026` — https://doi.org/10.3847/1538-4357/ae907e
- `QUAOAR_ICE_PLUS_DENSITY` — composite evidence key: QUAOAR_ICE_NATURE_2004 + QUAOAR_APJ_2026.
- `ORCUS_ICE_AA_2008` — https://www.aanda.org/articles/aa/pdf/2008/07/aa9079-07.pdf
- `ORCUS_THERMAL_2015` — https://doi.org/10.1016/j.icarus.2014.02.027
- `JWST_SEDNA_GONGGONG_QUAOAR_2024` — https://doi.org/10.1016/j.icarus.2024.116017
- `SALACIA_BINARY_2012` — https://www2.boulder.swri.edu/~buie/biblio/pub084.pdf
- `VARDA_BINARY_2015` — https://www.sciencedirect.com/science/article/abs/pii/S0019103515001797
- `IXION_ICARUS_2010` — https://doi.org/10.1016/j.icarus.2010.03.014
- `VARUNA_NIR_2014` — https://www.iac.es/en/science-and-technology/publications/rotationally-resolved-spectroscopy-20000-varuna-near-infrared

## Quantitative planet criteria

- Margot (2015), AJ 150:185 — https://arxiv.org/abs/1507.06300
...
- Every non-pending evidence state requires a resolvable source key in this file or an explicitly documented composite key.
- Scientific missingness is never zero-filled.
- Surface composition is not automatically bulk composition.
