...
- Candidates with >=2 observed pre and >=2 observed post WHR years in a ±4-year window: **18**.
- Of those, candidates whose treatment year is already verified: **11**.
...
- Freeze-eligible legal events (verified timing + WHR coverage): **11**.
