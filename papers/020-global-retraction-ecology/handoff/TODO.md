...
- [ ] Run `code/acquire_rwdb.py`.
- [ ] Commit source manifest, not the raw CSV.
- [ ] Audit row count, identifiers, dates, duplicate DOI patterns and missingness.
- [ ] Freeze Retraction-only primary inclusion criteria.
...
- [ ] Stress-test mass-retraction/paper-mill episode sensitivity.
